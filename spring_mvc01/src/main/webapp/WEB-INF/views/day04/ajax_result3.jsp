		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td><input type="password" size="10" name="m_pw" name="m_age" id="m_pw"></td>
	...
	<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(data) {
					...
					$(data).find("member").each(function() {
						...
						tbody += "<td><input type='button' value='삭제' id='member_del' name='"+ (this).find("m_idx") +"'></td>";
						tbody +="</tr>";
					});
					$("#tbody").append(tbody);
				},
		...
		$("#list").on("click", "#member_del", function() {
			...
			$.ajax({
				...
				data : "m_idx=" + $(this).attr("name"),  // 파라미터(하나일때 사용)
				method : "post",
				dataType : "text",
				success : function(data) {
					if(data == '0'){
