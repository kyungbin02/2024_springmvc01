...
<body>
	<h1>SNS 로그인</h1>
	<!-- 인가 코드 받기 요청 -->
	<a href="https://kauth.kakao.com/oauth/authorize?client_id=46219c457fde92498ef0e8fd7557a02c&redirect_uri=http://localhost:8080/kakaologin&response_type=code">
		<img alt="카카오" src="resources/images/kakao_login_medium.png"></a>
	<br>
	<a href="https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=1z3vLL61A63Vasymq_ja&redirect_uri=http://locallhost:8080/naverlogin&state=SPRING-TEST">
