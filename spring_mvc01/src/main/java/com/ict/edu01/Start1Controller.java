...
// 컨트롤러는 어노테이션 하지 않으면 반드시 Controller를 구현(implements)해야 한다.
public class Start1Controller implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//         |====== Business 레이어 ======|	     |= Repository레이어 =|
		
		// JSP에서 표현하기 위해서 값 저장하는 방법
		// 1. request 이용(JSP MVC와 같음) (비추천)	옛날방식 우우
		 request.setAttribute("name", "홍길동");	  //request에 저장
